// Build this OS applet into erpnext/public/os-applets/, guarded so erpnext still installs on
...
// guaranteed during erpnext's own build layer: frappe (and its already-built frappe-os) is
// installed first, and layers are cumulative — so erpnext's build sees it. On stock frappe
